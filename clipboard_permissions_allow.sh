...
echo "";
echo '  💝 Paste a list of package names you would like to give clipboard read permissions to and press Ctrl+D when done:'
echo "";
...
do
  ...
  adb shell cmd appops set $target_app READ_CLIPBOARD allow
done
